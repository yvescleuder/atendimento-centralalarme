                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input name="time_trigger" type="text" class="form-control timepicker" name="timepicker">
                                ...
                                <div class="col-md-6 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input name="time_checkin" type="text" class="form-control timepicker" name="timepicker">
                                            <div class="input-group-append">
                                                <span class="input-group-text"><i class="fa fa-clock"></i></span>
                                            </div>
                                        </div>
                                ...
                                <div class="col-md-6 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input name="time_exit" type="text" class="form-control timepicker" name="timepicker">
                                            <div class="input-group-append">
                                                <span class="input-group-text"><i class="fa fa-clock"></i></span>
                                            </div>
                                        </div>
